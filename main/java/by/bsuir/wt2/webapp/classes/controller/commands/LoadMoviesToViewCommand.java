 ...
 * @version 1.0
 */
public class LoadMoviesToViewCommand implements ICommand {

    private static final Logger logger = Logger.getLogger(LoadMoviesToViewCommand.class.getName());
    ...
    public PageAddress execute(HttpServletRequest request, HttpServletResponse response, ServletContext context) throws ServletException, IOException {
        PageAddress resultRedirectPage = PageAddresses.MOVIE_VIEW;
        List<Movie> cours;
        ...
        try {
            ...
            context.setAttribute("course", cours.get(Integer
